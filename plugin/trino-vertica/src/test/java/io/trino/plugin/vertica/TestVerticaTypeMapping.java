        ...
        extends AbstractTestQueryFramework
{
    ...
    public void setUp()
    {
        ...
        JdbcSqlExecutor executor = new JdbcSqlExecutor(verticaServer.getJdbcUrl(), verticaServer.getProperties());
    ...
    private void assertverticaqlQueryFails(@Language("SQL") String sql, String expectedMessage)
    {
        assertThatThrownBy(() -> verticaServer.execute(sql))
                .cause()
    ...
    public void testBoolean()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("trino.test_boolean"))
    ...
    {
        return new CreateAndInsertDataSetup(new JdbcSqlExecutor(verticaServer.getJdbcUrl(), verticaServer.getProperties()), tableNamePrefix);
    }
    ...
    public void testTinyint()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("tinyint", "-128", SMALLINT, "SMALLINT '-128'") // min value in verticaQL and Trino
                .addRoundTrip("tinyint", "5", SMALLINT, "SMALLINT '5'")
                .addRoundTrip("tinyint", "127", SMALLINT, "SMALLINT '127'") // max value in verticaQL and Trino
    ...
    public void testSmallint()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("smallint", "-32768", SMALLINT, "SMALLINT '-32768'") // min value in verticaQL and Trino
                .addRoundTrip("smallint", "32456", SMALLINT, "SMALLINT '32456'")
                .addRoundTrip("smallint", "32767", SMALLINT, "SMALLINT '32767'") // max value in verticaQL and Trino
                .execute(getQueryRunner(), verticaCreateAndInsert("trino.test_smallint"))
    ...
    {
        try (TestTable table = new TestTable(verticaServer::execute, "trino.test_unsupported_smallint", "(data smallint)")) {
            assertverticaqlQueryFails(
    ...
    public void testInteger()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("integer", "-2147483648", INTEGER, "-2147483648") // min value in verticaQL and Trino
                .addRoundTrip("integer", "1234567890", INTEGER, "1234567890")
                .addRoundTrip("integer", "2147483647", INTEGER, "2147483647") // max value in verticaQL and Trino
                .execute(getQueryRunner(), verticaCreateAndInsert("trino.test_int"))
    ...
    {
        try (TestTable table = new TestTable(verticaServer::execute, "trino.test_unsupported_integer", "(data integer)")) {
            assertverticaqlQueryFails(
    ...
    public void testBigint()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("bigint", "-9223372036854775808", BIGINT, "-9223372036854775808") // min value in verticaQL and Trino
                .addRoundTrip("bigint", "123456789012", BIGINT, "123456789012")
                .addRoundTrip("bigint", "9223372036854775807", BIGINT, "9223372036854775807") // max value in verticaQL and Trino
                .execute(getQueryRunner(), verticaCreateAndInsert("trino.test_bigint"))
    ...
    {
        try (TestTable table = new TestTable(verticaServer::execute, "trino.test_unsupported_bigint", "(data bigint)")) {
            assertverticaqlQueryFails(
    ...
    public void testDouble()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("double precision", "'-Infinity'::double precision", DOUBLE, "-infinity()")
                .execute(getQueryRunner(), verticaCreateAndInsert("vertica_test_double"));
    ...
    public void testDecimal()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("decimal(38, 38)", "CAST('-0.27182818284590452353602874713526624977' AS decimal(38, 38))", createDecimalType(38, 38), "CAST('-0.27182818284590452353602874713526624977' AS decimal(38, 38))").execute(getQueryRunner(), verticaCreateAndInsert("test_decimal"))
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), sessionWithDecimalMappingAllowOverflow(UNNECESSARY, 5), verticaCreateAndInsert("test_unspecified_decimal"));
    }
    ...
    public void testChar()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("test_char"))
        ...
        String verticaqlType = format("char(%s)", length);
        Type trinoType = createVarcharType(length);
        SqlDataTypeTest.create()
                .addRoundTrip(verticaqlType, "'test_f'", trinoType, format("'test_f%s'", " ".repeat(length - 6)))
                .addRoundTrip(verticaqlType, format("'%s'", "a".repeat(length)), trinoType, format("'%s'", "a".repeat(length)))
                .addRoundTrip(verticaqlType, "'\uD83D\uDE02'", trinoType, format("'\uD83D\uDE02%s'", " ".repeat(length - 1)))
                .execute(getQueryRunner(), verticaCreateAndInsert("test_char"));
    }
    ...
    public void testVarchar()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("test_varchar"))
    ...
    public void testUnboundedVarchar()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("test_unbounded_varchar"))
    ...
    {
        // verticaQL's BYTEA is mapped to Trino VARBINARY. verticaQL does not have VARBINARY type.
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("test_bytea"));
    ...
    {
        JdbcSqlExecutor jdbcSqlExecutor = new JdbcSqlExecutor(verticaServer.getJdbcUrl(), verticaServer.getProperties());
    ...
    {
        return Session.builder(getSession())
                .setSystemProperty("vertica.array_mapping", AS_ARRAY.name())
                .build();
    }
    ...
    {
        return Session.builder(getSession())
                .setCatalogSessionProperty("verticaql", DECIMAL_MAPPING, STRICT.name())
                .setCatalogSessionProperty("verticaql", UNSUPPORTED_TYPE_HANDLING, unsupportedTypeHandling.name())
                .build();
    }
    ...
    private void testUnsupportedDataTypeConvertedToVarchar(Session session, String dataTypeName, String internalDataTypeName, String databaseValue, String trinoValue)
    {
        ...
        try (TestTable table = new TestTable(
            ...
            Session convertToVarchar = Session.builder(session)
                    .setCatalogSessionProperty("verticaql", UNSUPPORTED_TYPE_HANDLING, CONVERT_TO_VARCHAR.name())
                    .build();
            assertQuery(
                    convertToVarchar,
    ...
    public void testArrayDisabled()
    {
        Session session = Session.builder(getSession())
                .setCatalogSessionProperty("verticaql", VerticaSqlSessionProperties.ARRAY_MAPPING, DISABLED.name())
                .build();
    ...
    public void testArray()
    {
        ...
        arrayDateTest(TestVerticaTypeMapping::trinoArrayFactory)
        ...
        arrayDateTest(TestVerticaTypeMapping::verticaArrayFactory)
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_array_date"));

        arrayDecimalTest(TestVerticaTypeMapping::trinoArrayFactory)
        ...
        arrayDecimalTest(TestVerticaTypeMapping::verticaArrayFactory)
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_array_decimal"));

        arrayVarcharTest(TestVerticaTypeMapping::trinoArrayFactory)
        ...
        arrayVarcharTest(TestVerticaTypeMapping::verticaArrayFactory)
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_array_varchar"));
        ...
        arrayUnicodeDataTypeTest(TestVerticaTypeMapping::trinoArrayFactory)
        ...
        arrayUnicodeDataTypeTest(TestVerticaTypeMapping::verticaArrayFactory)
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_array_parameterized_char_unicode"));
        arrayVarcharUnicodeDataTypeTest(TestVerticaTypeMapping::trinoArrayFactory)
        ...
        arrayVarcharUnicodeDataTypeTest(TestVerticaTypeMapping::verticaArrayFactory)
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_array_parameterized_varchar_unicode"));
    }
    ...
    public void testInternalArray()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), sessionWithArrayAsArray(), verticaCreateAndInsert("test_array_with_native_name"));
    }
    ...
    {
        // TODO: Migrate from DataTypeTest. SqlDataTypeTest fails when verifying predicates since we don't support comparing arrays containing NULLs, see https://github.com/trinodb/trino/issues/11397.
        // for multidimensional arrays, verticaQL requires subarrays to have the same dimensions, including nulls
    ...
    private static String verticaArrayFactory(String elementType)
    {
        return elementType + "[]";
    }
    ...
    public static DataType<ZonedDateTime> trinoTimestampWithTimeZoneDataType(int precision)
    {
        return dataType(
                ...
                // verticaQL does not store zone, only the point in time
    ...
    public void testDate(ZoneId sessionZone)
    {
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_date"))
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("test_date_min"));
        SqlDataTypeTest.create()
    ...
    public void testTime(ZoneId sessionZone)
    {
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_time"))
    ...
    {
        try (TestTable testTable = new TestTable(
                new JdbcSqlExecutor(verticaServer.getJdbcUrl(), verticaServer.getProperties()),
                "test_time_24",
...
//                    .isNotFullyPushedDown(AggregationNode.class);
    ...
    public void testTimestamp(ZoneId sessionZone)
    {
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, verticaCreateAndInsert("test_timestamp"))
    ...
    public void testTimestampWithTimeZone(boolean insertWithTrino)
    {
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), verticaCreateAndInsert("test_timestamp_with_time_zone"));
        }
    }
    ...
    public static DataType<ZonedDateTime> timestampWithTimeZoneDataType(int precision, boolean insertWithTrino)
    {
        ...
        return verticaTimestampWithTimeZoneDataType(precision);
    }

    public static DataType<ZonedDateTime> verticaTimestampWithTimeZoneDataType(int precision)
    {
        return dataType(
                format("timestamp(%d) with time zone", precision),
                createTimestampWithTimeZoneType(precision),
    ...
    public void testUuid()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), verticaCreateAndInsert("vertica_test_uuid"))
