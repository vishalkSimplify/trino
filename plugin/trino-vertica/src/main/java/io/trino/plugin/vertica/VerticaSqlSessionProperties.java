...
import io.trino.plugin.vertica.VerticaSqlConfig.ArrayMapping;
...
public class VerticaSqlSessionProperties
        implements SessionPropertiesProvider
{
    ...
    @Inject
    public VerticaSqlSessionProperties(VerticaSqlConfig veticaSqlConfig)
    {
        sessionProperties = ImmutableList.of(
                enumProperty(
                        ARRAY_MAPPING,
                        "Handling of Vertica arrays",
                        ArrayMapping.class,
                        veticaSqlConfig.getArrayMapping(),
                        false),
                booleanProperty(
                        ENABLE_STRING_PUSHDOWN_WITH_COLLATE,
                        "Enable string pushdown with collate (experimental)",
                        veticaSqlConfig.isEnableStringPushdownWithCollate(),
                        false));
    }
